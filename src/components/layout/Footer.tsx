    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-lg font-semibold mb-4">eSalesOne</h3>
            <p className="text-gray-400 text-sm">
              Your one-stop destination for trendy fashion and lifestyle products.
              Shop the latest collections with us.
            </p>
          </div>
          ...
          <div>
            ...
            <form className="flex gap-2">
              <input
                ...
                className="px-4 py-2 rounded-lg text-gray-900 text-sm w-full"
              />
              <button
                type="submit"
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 eSalesOne. All rights reserved.
            </p>
